...
@section('content')
    <div class="d-flex justify-content-between align-items-end mb-3">
        ...
        @else
                <a href="{{ route('users.index') }}" class="btn btn-outline-dark">Volver a Listado de Usuarios</a>
        @endif
        </p>
    </div>
    ...
    @if ($users->isNotEmpty())
        ...
        <div class="table-responsive-lg">
            <table class="table table-sm">
                ...
                <tr>
                    <th scope="col">#</th>
                    <th scope="col"><a href="{{ $sortable->url('first_name') }}" class="{{ $sortable->classes('name') }}">Nombre <i class="icon-sort"></i></a></th>
