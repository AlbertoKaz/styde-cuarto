    ...
    <td class="text-right">
        ...
        @else
            <form action="{{ route('users.trash', $user) }}" method="POST">
                @csrf
                @method('PATCH')
                <a href="{{ route('users.show', $user) }}" class="btn btn-outline-secondary btn-sm"><span class="bi bi-eye-fill"></span></a>
                <a href="{{ route('users.edit', $user) }}" class="btn btn-outline-secondary btn-sm"><span class="bi bi-pencil-fill"></span></a>
                <button type="submit" class="btn btn-outline-danger btn-sm"><span class="bi bi-trash-fill"></span></button>
            </form>
        @endif
    </td>
</tr>
